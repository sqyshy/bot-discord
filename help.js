...
function getHelpPage(page, userId, isAdmin) {
    ...
    if (page === 1) {
        title = '🔊 Voice & Confession Help';
        description = 'Control your temporary voice channels and use the anonymous confession panel.';
        fields = [
            {
            ...
            {
                name: 'Confession Panel',
                value: '**/setupconfession** - Setup confession panel in a text channel'
            }
        ];
    } else if (page === 2) {
        ...
        fields = [
            {
                ...
                value: [
                    ...
                    '**/log-setup** - Setup a logs channel',
                    '**/log-remove** - Delete logs channel',
                    '**/global-setup** - Auto-setup both vc and logs',
